...
class TD3:
    ...
    def remember(self, state, action, reward, state_, done):
        self.memory.store_transition(self, action, reward, state_, done)
    ...
    def learn(self):
        ...
        with T.no_grad():
            ...
            next_states_tensor = T.clamp(next_states_tensor + action_noise, -1, 1)
        ...
        critic1_loss = F.mse_loss(q1, target.detach()) # 放弃梯度
